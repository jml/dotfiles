...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (auto-package-update company-box helm-lsp company-lsp helm-config lsp-ui helm-company dap-mode dracula-theme groovy-mode bubbleberry-theme flycheck-kotlin kotlin-mode flycheck-pyre ansible-vault jinja2-mode isortify pyenv-mode flycheck-gradle gradle-mode pipenv ag blacken cargo commander dash dash-at-point diff-hl direnv docker dockerfile-mode drag-stuff el-get epl exec-path-from-shell expand-region f flycheck-cask flycheck-gometalinter flycheck-haskell flycheck-package flycheck-pyflakes flycheck-swift flycheck-swiftlint git git-gutter-fringe go-impl go-projectile go-snippets graphql-mode graphviz-dot-mode haskell-snippets helm-ag helm-flycheck helm-git-grep helm-hoogle helm-nixos-options helm-projectile hindent htmlize idle-highlight-mode intero magit-gh-pulls magit-todos markdown-mode multiple-cursors nix-mode org package-build pallet paradox paredit pretty-sha-path prodigy projectile-direnv protobuf-mode psci python-docstring s shakespeare-mode shut-up smart-mode-line-powerline-theme smartparens smex string-inflection swift-mode terraform-mode toml-mode tuareg visual-fill-column web-mode yafolding yaml-mode yasnippet-snippets)))
