...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (auto-package-update company-box helm-lsp company-lsp helm-config lsp-ui helm-company dap-mode dracula-theme groovy-mode bubbleberry-theme flycheck-kotlin kotlin-mode ansible-vault jinja2-mode isortify pyenv-mode flycheck-gradle gradle-mode pipenv ag blacken cargo commander dash dash-at-point diff-hl direnv docker dockerfile-mode el-get epl exec-path-from-shell expand-region f flycheck-gometalinter flycheck-haskell flycheck-pyflakes git go-impl go-projectile go-snippets graphql-mode graphviz-dot-mode haskell-snippets helm-ag helm-git-grep helm-projectile hindent intero magit-todos markdown-mode multiple-cursors nix-mode org package-build pallet paradox paredit pretty-sha-path projectile-direnv protobuf-mode psci python-docstring s shut-up smart-mode-line-powerline-theme smartparens string-inflection terraform-mode toml-mode visual-fill-column web-mode yaml-mode yasnippet-snippets)))
